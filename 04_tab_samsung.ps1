...
# Alturas de grupos
$AGH1 = $APY + 2*($ABTH+$AGY) - $AGY + 14   # Grupo1: 2 filas
$AGH2 = $APY + 3*($ABTH+$AGY) - $AGY + 14   # Grupo2: 3 filas
$AGH3 = $APY + 2*($ABTH+$AGY) - $AGY + 14   # Grupo3: 2 filas
...
# --- GRUPOS ---
$grpA1 = New-GBox $tabAdb "BASICO E INFORMACION"   $AX $AY1 $AGW $AGH1 "Cyan"
$grpA2 = New-GBox $tabAdb "REPARACION Y SEGURIDAD" $AX $AY2 $AGW $AGH2 "Orange"
$grpA3 = New-GBox $tabAdb "HERRAMIENTAS AVANZADAS" $AX $AY3 $AGW $AGH3 "Lime"
...
$btnRebootRec =$btnsA1[2]; $btnRebootBl =$btnsA1[3]
$btnRemFRP    =$btnsA2[0]
...
#==========================================================================
# G4 - GESTION CLIENTES / FIRMWARE
# Debajo de G3 (Herramientas MTK), misma columna izquierda
# 2 botones en 1 fila: CREAR FICHA CLIENTE | ORGANIZAR FIRMWARE
#==========================================================================
$GX_GH4  = $GX_PPY + 1*($GX_BTH+$GX_GGY) - $GX_GGY + 14   # 1 sola fila
$GX_Y4B  = $GX_Y3B + $GX_GH3 + $GX_GGAP

$grpG4 = New-GBox $tabGen "GESTION CLIENTES / FIRMWARE" $GX_PAD $GX_Y4B $GX_GW $GX_GH4 "Yellow"

$GL4 = @("CREAR FICHA CLIENTE", "ORGANIZAR FIRMWARE")
$btnsG4 = Place-Grid $grpG4 $GL4 "Yellow" 2 $GX_BTW $GX_BTH $GX_PPX $GX_PPY $GX_GGX $GX_GGY

$btnCrearFicha  = $btnsG4[0]
$btnOrganizarFW = $btnsG4[1]
